###########################################################################
## Makefile generated for component 'SIMULINK_SERIAL_PROOF_OF_CONCEPT'. 
## 
## Makefile     : SIMULINK_SERIAL_PROOF_OF_CONCEPT.mk
## Generated on : Mon Jan 25 14:50:59 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/SIMULINK_SERIAL_PROOF_OF_CONCEPT.elf
...
PRODUCT_NAME              = SIMULINK_SERIAL_PROOF_OF_CONCEPT
MAKEFILE                  = SIMULINK_SERIAL_PROOF_OF_CONCEPT.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2020b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2020b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/tcbir/Documents/MATLAB/RSED/Capstone_RSED
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH        = C:/Users/tcbir/DOCUME~1/MATLAB/R2020b/ARDUIN~1/ARDUIN~2/FASTER~2
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/SIMULINK_SERIAL_PROOF_OF_CONCEPT.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -D_MW_ARDUINO_LOOP_=1 -DMW_ARDUINO_STEP_SIZE=200000 -DMW_ARDUINO_MICROS -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=SIMULINK_SERIAL_PROOF_OF_CONCEPT -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = SIMULINK_SERIAL_PROOF_OF_CONCEPT.o SIMULINK_SERIAL_PROOF_OF_CONCEPT_data.o updown.o ext_work.o rtiostream_utils.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_interface.o ext_svr_daemon.o rtiostream_serial_daemon.o daemon_checksum.o
...
%.o : $(START_DIR)/SIMULINK_SERIAL_PROOF_OF_CONCEPT_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/SIMULINK_SERIAL_PROOF_OF_CONCEPT_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/SIMULINK_SERIAL_PROOF_OF_CONCEPT_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
SIMULINK_SERIAL_PROOF_OF_CONCEPT.o : $(START_DIR)/SIMULINK_SERIAL_PROOF_OF_CONCEPT_ert_rtw/SIMULINK_SERIAL_PROOF_OF_CONCEPT.c
	$(CC) $(CFLAGS) -o "$@" "$<"


SIMULINK_SERIAL_PROOF_OF_CONCEPT_data.o : $(START_DIR)/SIMULINK_SERIAL_PROOF_OF_CONCEPT_ert_rtw/SIMULINK_SERIAL_PROOF_OF_CONCEPT_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/SIMULINK_SERIAL_PROOF_OF_CONCEPT_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
