...
PRODUCT_NAME              = SIMULINK_RSED_MODEL
MAKEFILE                  = SIMULINK_RSED_MODEL.mk
...
SLIB_PATH                   = C:/Users/tcbir/DOCUME~1/MATLAB/R2020b/ARDUIN~1/ARDUIN~4/FASTER~1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/SIMULINK_RSED_MODEL.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=8 -DMW_TIMERCOUNT=131250 -DMW_SAM_CLOCKID=TC_CMR_TCCLKS_TIMER_CLOCK4 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=SIMULINK_RSED_MODEL -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = xcp_ext_work.o SIMULINK_RSED_MODEL.o SIMULINK_RSED_MODEL_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_frame_serial.o xcp_ext_param_default_serial.o arm_m3_cortex_handler.o MW_ArduinoHWInit.o io_wrappers.o arduinoARMScheduler.o m3m4m4f_multitasking.o rtiostream_serial_daemon.o sys_arch.o
...
%.o : $(START_DIR)/SIMULINK_RSED_MODEL_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/SIMULINK_RSED_MODEL_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/SIMULINK_RSED_MODEL_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/SIMULINK_RSED_MODEL_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/SIMULINK_RSED_MODEL_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
SIMULINK_RSED_MODEL.o : $(START_DIR)/SIMULINK_RSED_MODEL_ert_rtw/SIMULINK_RSED_MODEL.c
	$(CC) $(CFLAGS) -o "$@" "$<"


SIMULINK_RSED_MODEL_data.o : $(START_DIR)/SIMULINK_RSED_MODEL_ert_rtw/SIMULINK_RSED_MODEL_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/SIMULINK_RSED_MODEL_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/SIMULINK_RSED_MODEL_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/SIMULINK_RSED_MODEL_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/SIMULINK_RSED_MODEL_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
