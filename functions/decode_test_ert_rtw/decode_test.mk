###########################################################################
## Makefile generated for component 'decode_test'. 
## 
## Makefile     : decode_test.mk
## Generated on : Wed May 05 22:29:03 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/decode_test.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/decode_test.elf
...
DEFINES_STANDARD = -DMODEL=decode_test -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = xcp_ext_work.o decode_test.o decode_test_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_frame_serial.o xcp_ext_param_default_serial.o arm_m3_cortex_handler.o MW_ArduinoHWInit.o io_wrappers.o arduinoARMScheduler.o m3m4m4f_multitasking.o rtiostream_serial_daemon.o sys_arch.o
...
%.o : $(START_DIR)/decode_test_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/decode_test_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/decode_test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/decode_test_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/decode_test_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
decode_test.o : $(START_DIR)/decode_test_ert_rtw/decode_test.c
	$(CC) $(CFLAGS) -o "$@" "$<"


decode_test_data.o : $(START_DIR)/decode_test_ert_rtw/decode_test_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/decode_test_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
