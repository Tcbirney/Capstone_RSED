...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/sizing_test.elf
...
DEFINES_STANDARD = -DMODEL=sizing_test -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = sizing_test.o sizing_test_data.o updown.o ext_work.o rtiostream_utils.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_interface.o ext_svr_daemon.o rtiostream_serial_daemon.o daemon_checksum.o
...
%.o : $(START_DIR)/sizing_test_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/sizing_test_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/sizing_test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/sizing_test_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


sizing_test.o : $(START_DIR)/sizing_test_ert_rtw/sizing_test.c
	$(CC) $(CFLAGS) -o "$@" "$<"


sizing_test_data.o : $(START_DIR)/sizing_test_ert_rtw/sizing_test_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
