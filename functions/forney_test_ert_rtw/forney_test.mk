###########################################################################
## Makefile generated for component 'forney_test'. 
## 
## Makefile     : forney_test.mk
## Generated on : Mon May 03 14:51:05 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/forney_test.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/forney_test.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -D_MW_ARDUINO_LOOP_=1 -DMW_ARDUINO_STEP_SIZE=1000000 -DMW_ARDUINO_MICROS -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=forney_test -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = forney_test.o forney_test_data.o updown.o ext_work.o rtiostream_utils.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_interface.o ext_svr_daemon.o rtiostream_serial_daemon.o daemon_checksum.o
...
%.o : $(START_DIR)/forney_test_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/forney_test_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/forney_test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/forney_test_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


forney_test.o : $(START_DIR)/forney_test_ert_rtw/forney_test.c
	$(CC) $(CFLAGS) -o "$@" "$<"


forney_test_data.o : $(START_DIR)/forney_test_ert_rtw/forney_test_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
