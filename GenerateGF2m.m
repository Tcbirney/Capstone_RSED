...
alphaPower = 1; 
isTap = 0;
s_reg = zeros(1,m);%what is the initial condition of the shift register?
s_reg(end) = 1; %rightmost element of init shr is 1
gf(1, :) = [0 0 0];%write the contents of the init shift register to the matrix of gf elements
gf(2, :) = s_reg;
